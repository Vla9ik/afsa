(() => {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".posts-slider__slider")) new swiper_core_Swiper(".posts-slider__slider", {
    ...
    class DynamicAdapt {
        ...
        init() {
            ...
            this.nodes.forEach((node => {
                ...
                const dataArrayGroups = data.split("|");
                dataArrayGroups.forEach((dataGroup => {
                    const dataArray = dataGroup.split(",");
                    const оbject = {};
                    оbject.element = node;
    ...
    document.querySelectorAll(".filters").forEach((filter => {
        filter.addEventListener("click", (event => {
            if (event.target.classList.contains("filters__link")) {
                filter.querySelectorAll(".filters__link").forEach((link => {
